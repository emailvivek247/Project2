...
public class EmailProducer {
    ...
    public void sendMailUsingTemplate(final EComAdminUserEvent userEvent) {
        ...
        data.put("requestURL", userEvent.getRequestURL());
    ...
    public void sendEmail(String fromEmailId, String toEmailId, String subject, String txtMessage, String requestURL) {
        Map<String, Object> data = new HashMap<String, Object>();
